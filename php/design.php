...
session_start();
    ...
    @mysqli_select_db("education",$conn);
		...
		$result=mysqli_query($conn,"SELECT subject,description FROM design where id='1' ");
        @$q2=mysqli_fetch_assoc($result);
        $subject1=$q2['subject'];
        $description1=$q2['description'];
        
		$result1=mysqli_query($conn,"SELECT subject,description FROM design where id='2' ");
        @$q2=mysqli_fetch_assoc($result1);
        $subject2=$q2['subject'];
        $description2=$q2['description'];
		
		$result2=mysqli_query($conn,"SELECT subject,description FROM design where id='3' ");
        @$q2=mysqli_fetch_assoc($result2);
        $subject3=$q2['subject'];
        $description3=$q2['description'];
		
		$result3=mysqli_query($conn,"SELECT subject,description FROM design where id='4' ");
        @$q2=mysqli_fetch_assoc($result3);
        $subject4=$q2['subject'];
        $description4=$q2['description'];
		
		$result4=mysqli_query($conn,"SELECT subject,description FROM design where id='5' ");
        @$q2=mysqli_fetch_assoc($result4);
        $subject5=$q2['subject'];
        $description5=$q2['description'];
		
		$result5=mysqli_query($conn,"SELECT subject,description FROM design where id='6' ");
        @$q2=mysqli_fetch_assoc($result5);
        $subject6=$q2['subject'];
        $description6=$q2['description'];
		
		$result6=mysqli_query($conn,"SELECT subject,description FROM design where id='7' ");
        @$q2=mysqli_fetch_assoc($result6);
        $subject7=$q2['subject'];
        $description7=$q2['description'];
		
		$result7=mysqli_query($conn,"SELECT subject,description FROM design where id='8' ");
...
?>
    ...
    <div class="scroll">
        <div class="courselist">
            ...
            <h4 class="lin"><a href="photography.php ">Photography</a></h4>
    ...
    <div class="bigbox">
        <div class="freecrse">
            <h2 class="linee">Design Course</h2>
...
<div class="box-container">
    ...
    <div class="box">
        <img src="../images/design4.jfif" alt=""> 
    ...
    <div class="box">
        <img src="../images/design3.jfif" alt="">
        ...
        <div class="content">
            ...
            <a href="corsedtail.php" class="title"><?php echo "$subject2" ?></a></a>
    ...
    <div class="box">
        <img src="../images/design2.jfif" alt="">
	...
	<div class="box">
        <img src="../images/design1.jfif" alt="">
